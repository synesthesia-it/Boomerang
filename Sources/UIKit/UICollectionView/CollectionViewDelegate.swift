...
extension CollectionViewDelegate: UICollectionViewDelegateFlowLayout {
    ...
    open func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForHeaderInSection section: Int) -> CGSize {
        return sizeCalculator.sizeForItem(at: IndexPath(item: 0, section: section), in: collectionView, direction: nil, type: UICollectionView.elementKindSectionHeader)
    }
    open func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForFooterInSection section: Int) -> CGSize {
        return sizeCalculator.sizeForItem(at: IndexPath(item: 0, section: section), in: collectionView, direction: nil, type: UICollectionView.elementKindSectionFooter)
    }
