...
class ShowCastDetailViewController: UIViewController {
    let viewModel: ShowCastDetailViewModel
    ...
    init(viewModel: ShowCastDetailViewModel, components: ComponentFactory) {
        self.viewModel = viewModel
        self.components = components
        super.init(nibName: "ShowCastDetailViewController", bundle: nil)
