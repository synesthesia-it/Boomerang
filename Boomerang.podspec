#
#  Be sure to run `pod spec lint Boomerang.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  someday I'll write a meaningful description
                   DESC
  ...
  # Or just: spec.author    = "Stefano Mondino"
  # spec.authors            = { "Stefano Mondino" => "stefano.mondino.dev@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Stefano Mondino"
  ...
  spec.source       = { :git => "https://github.com/stefanomondino/newark.git", :tag => "#{spec.version}" }
